...
public class ItemController {
	...
	public String itemNew(@Valid ItemFormDto itemFormDto, BindingResult bindingResult,
		...
		//상품등록 전에 첫번째 이미지가 있는지 없는지 검사(첫번째 이미지는 필수입력값)
	 ...
	 * Optional<Integer> page, Model model) { //of(조회할 페이지의 번호<★0부터 시작>, 한 페이지당 조회할
	 * 데이터 갯수) //url 경로에 페이지가 있으면 해당 페이지 번호를 조회하도록 하고 페이지 번호가 없으면 0페이지를 조회 Pageable
